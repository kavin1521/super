...
import { Text, View, Alert, SafeAreaView , StyleSheet, Platform , StatusBar, ImageBackground, Image,Dimensions} from 'react-native';
            ...
            <View>
                <ImageBackground source={bg_image} style={styles.background}>
                    <View style={styles.gifContainer}>
                        ...
                        <View>
                            <Text style={[styles.titleCard,{marginTop:400,marginLeft:50}]}>{item.name}</Text>
